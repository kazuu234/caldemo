  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "h-9 w-9 p-0 font-normal text-center rounded-md transition-colors hover:bg-accent hover:text-accent-foreground aria-selected:opacity-100 disabled:pointer-events-none disabled:opacity-50",
